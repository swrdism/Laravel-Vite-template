...
install:
	docker exec -it laravel-vite-vue_workspace pnpm i
...
dev:
	docker exec -it laravel-vite-vue_workspace pnpm vite

serve:
	docker exec -it laravel-vite-vue_workspace pnpm build
