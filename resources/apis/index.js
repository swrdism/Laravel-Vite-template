...
if (process.env.NODE_ENV !== "production") {
	const { apiFetchMockSinglePropertyServer } = initMockServer(mockAxiosInstance);
	mockAxiosInstance.interceptors.response.use(interceptorSuccess, interceptorError);
